// Command elder-care-backend starts the generated HTTP service.
package main
...
import (
	...
	_ "dev.choveylee.top/elder-care-backend/cmd/init"

	"dev.choveylee.top/elder-care-backend/internal/const"
	"dev.choveylee.top/elder-care-backend/internal/cron"
	"dev.choveylee.top/elder-care-backend/internal/lib"
	"dev.choveylee.top/elder-care-backend/internal/model"
	"dev.choveylee.top/elder-care-backend/internal/router"
